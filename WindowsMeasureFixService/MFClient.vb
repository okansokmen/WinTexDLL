...
Public Class MFClient
    ...
    Public Function GetSipModelBeden() As String
        ...
        Try
            ...
            oSQL.cSQLQuery = "select top 1 siparisno, stokno, renk, beden, " +
                            " beden2 = case when charindex('/',beden) > 0 " +
                                        " then rtrim(substring(beden,1,charindex('/',beden)-1)) " +
                                        " when charindex('-',beden) > 0 " +
                                        " then rtrim(substring(beden,1,charindex('-',beden)-1)) " +
                                        " else rtrim(beden) " +
                                    " end " +
            ...
            If oSQL.oReader.Read Then
                ...
                cBeden2 = oSQL.SQLReadString("beden2")
            End If
            oSQL.oReader.Close()
    ...
    Public Async Function WriteMeasures(cMessage As String) As Task
        ...
        Try
            ...
            If lOK Then
                ...
                oSQL.cSQLQuery = "set dateformat dmy " +
                                ...
                                " beden = '" + SQLWriteString(cBeden2, 30) + "', " +
                ...
                For nCnt = 0 To aOlcu.GetUpperBound(0)
                    ...
                    oSQL.cSQLQuery = "insert qcfisolculines2 (fisno, olcumyeri, beden, olcu2, aciklama) " +
                                    ...
                                    " '" + SQLWriteString(cBeden2, 30) + "', " +
                                    " '" + SQLWriteDecimal(aOlcu(nCnt).nOlcu / 100000) + "', " +
    ...
    Public Function SendMeasures() As String
        ...
        Try
            ...
            Dim lOlcuBulundu As Boolean = False
            ...
            If oSQL.oReader.Read Then
                ...
                cMsg = "{'jsonrpc':'2.0'," +
                        ...
                        "'params':{'General':{'InternalId':'1'," +
                                            "'ItemId':'" + cSiparisNo + "'," +
                                            "'GarmentInfoName':'" + cSiparisNo + "_" + cBeden2 + "'," +
                                            "'BundleSize':1," +
                                            "'BundleId':0," +
            ...
            If cSiparisNo.Trim = "" Or cOlcuTablosuNo.Trim = "" Or cBeden2.Trim = "" Then
                CreateLog("Siparis / ölçü tablosu / beden bulunamadı : " + cSiparisNo.Trim + " / " + cOlcuTablosuNo + " / " + cBeden2)
                oSQL.CloseConn()
                Exit Function
            End If
            ...
            Do While oSQL.oReader.Read
                ...
                If IsNumeric(cTolerans) Then
                    nTolerans = Double.Parse(cTolerans, Globalization.CultureInfo.InvariantCulture) * 10
                End If
                ...
                If IsNumeric(cOlcu) Then
                    ...
                    nOlcu = Double.Parse(cOlcu, Globalization.CultureInfo.InvariantCulture) * 10
                    ...
                    cSection = "{'Id':" + nID.ToString + "," +
                                ...
                                "'User1':" + mf_user1 + "," +
                                "'Units':" + mf_units + "," +
                                "'Expected':'" + nOlcu.ToString("###.0000") + "'," +
                                "'Min':'" + nMin.ToString("###.0000") + "'," +
                                "'Max':'" + nMax.ToString("###.0000") + "'}"
            ...
            If Not lOlcuBulundu Then
                CreateLog("Ölçü bulunamadı : " + cSiparisNo.Trim + " / " + cOlcuTablosuNo + " / " + cBeden2)
            End If
            ...
            CreateLog("Ölçüler yollandı : " + cMsg)
