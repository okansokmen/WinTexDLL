...
Public Class SQLServerClass
    ...
    Public Sub New(Optional lDefault As Boolean = True, Optional cServer As String = "", Optional cDatabase As String = "", Optional cUsername As String = "", Optional cPassword As String = "")
        ...
        If lDefault Then
            cConnectionString = "Data Source=" + utilMeasureFix.oConnection.cServer + ";" +
                                "Initial Catalog=" + utilMeasureFix.oConnection.cDatabase + ";" +
                                "uid=" + utilMeasureFix.oConnection.cUser + ";" +
                                "pwd=" + utilMeasureFix.oConnection.cPassword + ""
        Else
