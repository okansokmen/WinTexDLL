...
namespace UHFAPP
{
    public partial class TempertureTag2MainForm : BaseForm
    {
        ...
        public TempertureTag2MainForm mainform = null;
        public TempertureTag2MainForm()
        {
            InitializeComponent();
               ...
               if (currForm == null || currentType != 0)
                {
                    ...
                    int old = currentType;
                    currentType = 0;
                    ReadEPCFormT2 frm_epcScan = new ReadEPCFormT2(isOpen, mainform);//子窗体实例化// ReadEPCForm frm_epcScan = (ReadEPCForm)Common.getForm("ReadEPCForm",this);//子窗体实例化
                    frm_epcScan.WindowState = FormWindowState.Maximized;
                    frm_epcScan.MdiParent = this;//设置当前窗体为子窗体的父窗体
                    frm_epcScan.Show();//显示窗体
                    if (currForm != null)
            ...
            try
            {
                ...
                { 
                   ...
                   // ConfigForm2 config = (ConfigForm2)Common.getForm("ConfigForm2", this);
                    TempertureTag2ReadEPCForm config = new TempertureTag2ReadEPCForm(isOpen, mainform);
