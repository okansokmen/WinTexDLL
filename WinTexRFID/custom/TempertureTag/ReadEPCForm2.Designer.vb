...
'ORIGINAL LINE: this.btnScanEPC.Click += new System.EventHandler(this.btnScanEPC_Click);
			...
			Me.lvEPC.Columns.AddRange(New System.Windows.Forms.ColumnHeader() { Me.columnHeaderID, Me.columnHeaderEPC, Me.columnHeaderTID, Me.columnHeaderRssi, Me.columnHeaderCount, Me.columnHeaderANT})
			...
			Me.lvEPC.Name = "lvEPC"
			Me.lvEPC.Size = New System.Drawing.Size(1287, 438)
			Me.lvEPC.TabIndex = 2
...
'ORIGINAL LINE: this.lvEPC.DoubleClick += new System.EventHandler(this.lvEPC_DoubleClick);
			...
			Me.columnHeaderEPC.Width = 700
			' 
			' columnHeaderTID
			' 
			Me.columnHeaderTID.Text = "TID"
			Me.columnHeaderTID.Width = 280
			' 
			' columnHeaderRssi
			' 
