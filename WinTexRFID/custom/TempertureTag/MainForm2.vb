...
Namespace UHFAPP
	Partial Public Class MainForm2
		...
		Public mainform As MainForm2 = Nothing
		Public Sub New()
			InitializeComponent()
		...
		Private Sub ScanEPC()
			Try
			   ...
			   If currForm Is Nothing OrElse currentType <> 0 Then
					...
					currentType = 0
					Dim frm_epcScan As New ReadEPCForm2(isOpen, mainform) '子窗体实例化// ReadEPCForm frm_epcScan = (ReadEPCForm)Common.getForm("ReadEPCForm",this);//子窗体实例化
					frm_epcScan.WindowState = FormWindowState.Maximized
			...
			Try
				...
				If currForm Is Nothing OrElse currentType <> 11 Then
				   ...
				   ' ConfigForm2 config = (ConfigForm2)Common.getForm("ConfigForm2", this);
					Dim config As New TempertureTagForm(isOpen, mainform)
