...
Public Class YkkWebApi
    ...
    Private ReadOnly Property Url() As String
        Get
            Dim cSetting As String = oConnection.cYKKApiUrl.Trim    ' https://ykkapi.ykk.com.tr
            Return cSetting
        End Get
    End Property
    ...
    Private ReadOnly Property UserName() As String
        Get
            Dim cSetting As String = oConnection.cYKKApiUserName.Trim ' ykk@eroglugiyim.com
            Return cSetting
        End Get
    End Property
    ...
    Private ReadOnly Property Password() As String
        Get
            Dim cSetting As String = oConnection.cYKKApiPassword.Trim ' €r0Glu2019!
            Return cSetting
        End Get
    End Property
    ...
    Private Sub Login()
        ...
        Catch yex As YkkClientException
            ErrDisp("Login", "ykkwebapi.vb",,, yex)
        Catch ex As Exception
            ErrDisp("Login", "ykkwebapi.vb",,, ex)
        End Try
    End Sub
    ...
    Public Function GetProducts(ByVal customerProductCode As String, ByVal topValue? As Integer, ByVal pagenumber? As Integer) As List(Of APICUSTOMERSPRODUCT)
        ...
        Catch yex As YkkClientException
            ErrDisp("GetProducts", "ykkwebapi.vb",,, yex)
        Catch ex As Exception
            ErrDisp("GetProducts", "ykkwebapi.vb",,, ex)
        End Try
    End Function
    ...
    Public Function GetDeliveryAddress(ByVal topValue As Integer, ByVal pagenumber As Integer) As List(Of APICustomerAdress)
        ...
        Catch yex As YkkClientException
            ErrDisp("GetDeliveryAddress", "ykkwebapi.vb",,, yex)
        Catch ex As Exception
            ErrDisp("GetDeliveryAddress", "ykkwebapi.vb",,, ex)
        End Try
    End Function
    ...
    Public Function GetOrder(ByVal orderNos As List(Of String), ByVal createStartDate? As Date, ByVal createEndDate? As Date, ByVal requestStartDate? As Date, ByVal requestEndDate? As Date) As List(Of APIOrderDetailResult)
        ...
        Catch yex As YkkClientException
            ErrDisp("GetOrder", "ykkwebapi.vb",,, yex)
        Catch ex As Exception
            ErrDisp("GetOrder", "ykkwebapi.vb",,, ex)
        End Try
    End Function
    ...
    Public Function SendOrder(ByVal _sasNo As String, ByVal _requestDate As Date, ByVal _time As APIOrderTimeConvention, ByVal _sampleOrder As Boolean, ByVal _buyerCode As String, ByVal _completeDelivery As Boolean, ByVal _deliveryCode1 As String, ByVal _deliveryCode2 As String, ByVal _orderComment As String, ByVal _noCommercial As Boolean, ByVal _eMail As String, ByVal _orderItems As List(Of APIOrderItems)) As String
        Try
            ...
            order.DeliverCode1 = _deliveryCode1.Trim   'Addressler üzerinden alınan DeliveryCode1 değeri
            order.DeliverCode2 = _deliveryCode2.Trim   'Adresslerden alınan DeliveryCode2 değeri
            ...
            order.Purchasecontractno = _sasNo.Trim     'Firmanızın varsa SAS numarasıdır. (Maximum 15 karakter)
            ...
            order.AssociatedMail = _eMail.Trim
            order.ApiOrderItems = _orderItems
            Login()
            Return Client.PostOrderAsync(order).GetAwaiter().GetResult()

        Catch yex As YkkClientException
            ErrDisp("SendOrder", "ykkwebapi.vb",,, yex)
        Catch ex As Exception
            ErrDisp("SendOrder", "ykkwebapi.vb",,, ex)
        End Try
    End Function
