...
Public Class SQLServerClass
    ...
    Public Sub New(Optional lDefault As Boolean = True, Optional cServer As String = "", Optional cDatabase As String = "", Optional cUsername As String = "", Optional cPassword As String = "", Optional cConStr As String = "")
        Try
            If lDefault Then
                If ConfigurationSettings.AppSettings("SERVER") Is Nothing Then
                    cServer = "192.168.1.8"
                    cDatabase = "TES"
                    cUsername = "sa"
                    cPassword = "er1303*?"
                Else
                    cServer = ConfigurationSettings.AppSettings("SERVER").ToString.Trim
                    cDatabase = ConfigurationSettings.AppSettings("DATABASE").ToString.Trim
                    cUsername = ConfigurationSettings.AppSettings("USERNAME").ToString.Trim
                    cPassword = ConfigurationSettings.AppSettings("PASSWORD").ToString.Trim
                End If
