...
Module UtilLogFile
    ...
    Public Sub AddEventLog(cMessage As String, Optional nCase As Integer = 1)
        Try
            ...
            If Not System.Diagnostics.EventLog.SourceExists("WintexSchedule") Then
                System.Diagnostics.EventLog.CreateEventSource("WintexSchedule", "WintexScheduleLog")
            End If

            oEventLog.Source = "WintexSchedule"
            oEventLog.Log = "WintexScheduleLog"

            cMessage = "WintexSchedule versiyon : " + My.Application.Info.Version.ToString.Trim + vbCrLf +
    ...
    Public Sub CreateLog(Optional ByVal cLogFileName As String = "WintexScheduleLog", Optional ByVal cLogMessage As String = "")
        Try
            Dim cTodaysDate As String = String.Format("{0:dd_MM_yyyy}", DateTime.Now)
            Dim cFileName As String = "C:\wintex\WintexScheduleLogs\" + cLogFileName + "_" + cTodaysDate + ".txt"
            ...
            Debug.WriteLine("WintexSchedule Log : " + cMessage)

            If (My.Computer.FileSystem.DirectoryExists("C:\wintex\WintexScheduleLogs") = False) Then
                My.Computer.FileSystem.CreateDirectory("C:\wintex\WintexScheduleLogs")
            End If
    ...
    Public Sub ErrDisp(Optional ByVal cErrorMessage As String = "", Optional ByVal cFormName As String = "", Optional ByVal cSQL As String = "", Optional ByVal lShowMessage As Boolean = False, Optional oEx As Exception = Nothing)
        Try
            Dim cTodaysDate As String = String.Format("{0:dd_MM_yyyy}", DateTime.Now)
            Dim cFileName As String = "C:\wintex\WinTexScheduleErrors\WinTexScheduleError" + "_" + cTodaysDate + ".txt"
            Dim cMessage As String = ""
            ...
            Debug.WriteLine("WinTexSchedule Hata : " + cMessage)

            If lShowMessage Then
                MsgBox("WinTexSchedule Hata : " + cMessage)
            End If

            If InStr(cMessage, "404") = 0 Then

                If (My.Computer.FileSystem.DirectoryExists("C:\wintex\WinTexScheduleErrors") = False) Then
                    My.Computer.FileSystem.CreateDirectory("C:\wintex\WinTexScheduleErrors")
                End If
