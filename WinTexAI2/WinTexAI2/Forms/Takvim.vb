...
Public Class Takvim
    ...
    Public Sub ResetGrid()
        ...
        Catch ex As Exception
            ErrDisp("ResetGrid : " + ex.Message, Me.Name,,, ex)
        End Try
    End Sub
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles Button15.Click
        ' XML Export
        Try
            If FileSystem.Dir("C:\wintex\ScheduleXML.xml") <> "" Then
                FileSystem.Kill("C:\wintex\ScheduleXML.xml")
            End If

            DbiSchedule1.WriteXMLFile("C:\wintex\ScheduleXML.xml")

            MsgBox("C:\wintex\ScheduleXML.xml dosyasına EXPORT edildi / aktarım yapıldı")

        Catch ex As Exception
            ErrDisp("Button15_Click : " + ex.Message, Me.Name,,, ex)
        End Try
    End Sub
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        ...
        Try
            If FileSystem.Dir("C:\wintex\ScheduleXML.xml") = "" Then
                MsgBox("C:\wintex\ScheduleXML.xml dosyası bulunamadı")
            Else
                DbiSchedule1.ReadXMLFile("C:\wintex\ScheduleXML.xml")
                DbiSchedule1.Refresh()
                MsgBox("C:\wintex\ScheduleXML.xml dosyası IMPORT edildi / okundu")
            End If

        Catch ex As Exception
            ErrDisp("Button16_Click : " + ex.Message, Me.Name,,, ex)
        End Try
