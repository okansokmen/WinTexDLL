...
namespace Luxand
{
    ...
    public unsafe partial class FSDK
    {
        ...
        [DllImport("facesdk.dll", EntryPoint = "FSDK_LoadImageFromBuffer", SetLastError = true, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("facesdk.dll", EntryPoint = "FSDK_GetImageBufferSize", SetLastError = true, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetImageBufferSize(int Image, ref int BufSize, FSDK_IMAGEMODE ImageMode);

        [DllImport("facesdk.dll", EntryPoint = "FSDK_SaveImageToBuffer", SetLastError = true, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
