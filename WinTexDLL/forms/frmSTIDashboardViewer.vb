...
<InteropForm()> Public Class frmSTIDashboardViewer
    ...
    Public Sub initViewer(Optional cReportID As String = "", Optional cReportVariable1 As String = "", Optional cReportVariable2 As String = "", Optional cReportVariable3 As String = "",
        ...
        Try
            ...
            StiDashboardViewerControl1.Report = oReport.oReportStimulus
    ...
    Private Sub frmSTIDashboardViewer_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
