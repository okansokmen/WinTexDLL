...
namespace DirectX.Capture
{
	...
	public class Capture : System.Windows.Forms.Form, ISampleGrabberCB
	{
		...
		/// <summary>
		/// Necesario para poder hacer una identificación cuando se lance el evento CaptureFrameCompleted
		/// </summary>
		/*public int Id
		{
			get
		...
		//protected int				id;									//Almacena un número que identifica a la cámara
		...
		/// <summary>
		/// Esta función hará un preview de la cámara, será utilizada cuando se pare la grabación de un video
		/// o para poder configurar la cámara.
		/// </summary>
		...
		protected void destroyGraph()
		{
			...
			//ELIMINAR RECURSOS CAPTURA <<<<<<<<<================================================
			if ( baseGrabFlt != null )
				Marshal.ReleaseComObject( baseGrabFlt ); baseGrabFlt = null;
