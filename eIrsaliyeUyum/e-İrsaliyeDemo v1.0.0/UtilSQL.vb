...
Namespace eIrsaliyeUyum
    ...
    Module UtilSQL
        ...
        Public Function OpenConn(Optional nTimeOut As Double = 0) As SqlConnection
            ...
            Try
                If nTimeOut = 0 Then
                    cConnStr = UtilRoot.oConnection.cConnStr
                Else
                    cConnStr = UtilRoot.oConnection.cConnStr + ";" + "Connection Timeout = " + nTimeOut.ToString
                End If
        ...
        Public Function TestConnection() As Boolean
            ...
            Try
                ...
                oConnectionTest = New SqlConnection(UtilRoot.oConnection.cConnStr)
        ...
        Public Function GetStreamAsByteArray(ByVal stream As System.IO.Stream) As Byte()
            ...
            Catch ex As Exception
                ErrDisp("GetStreamAsByteArray", "utilSQL",,, ex)
            End Try
        End Function
