...
Namespace eIrsaliyeUyum
    ...
    Module UtilRoot
        ...
        Public Structure oUyumConn
            Dim cUyumEirsaliyeServiceUrl As String
            Dim cUyumUsername As String
            Dim cUyumPassword As String
            Dim cUyumPortalUrl As String
            Dim cUyumPortalUsername As String
            Dim cUyumPortalPassword As String
            Dim cUyumirsservicestok As String
            Dim cUyumirsserviceuretim As String
            Dim cUyumirsdraft As String
            Dim cUyumSaticiFirma As String
        End Structure

        Public oUyumConnect As oUyumConn
