            ...
            Else
                Do While True
                    ...
                    cUrl = "http://www.tcmb.gov.tr/kurlar/" +
                            CStr(Format(Microsoft.VisualBasic.DateAndTime.Year(dTarih), "0000")) + CStr(Format(Microsoft.VisualBasic.DateAndTime.Month(dTarih), "00")) + "/" +
                            CStr(Format(Microsoft.VisualBasic.DateAndTime.Day(dTarih), "00")) + CStr(Format(Microsoft.VisualBasic.DateAndTime.Month(dTarih), "00")) + CStr(Format(Microsoft.VisualBasic.DateAndTime.Year(dTarih), "0000")) + ".xml"
