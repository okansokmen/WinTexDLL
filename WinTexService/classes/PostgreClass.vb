...
Public Class PostgreClass
    ...
    Public Sub New(Optional cServer As String = "", Optional cDatabase As String = "", Optional cUsername As String = "", Optional cPassword As String = "", Optional cConStr As String = "")
        Try
        ...
        Catch ex As Exception
            ErrDisp(ex, "New : " + cConnectionString)
        End Try
    End Sub
    ...
    Public Sub GetSQLReader(ByVal cSQL As String)
        ...
        Try
            oCommand = New PgSqlCommand(cSQL, oConnection) With {
                .CommandTimeout = 0
            }
