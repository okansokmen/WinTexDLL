...
Module UtilLogFile
    ...
    Public Sub CreateLog(Optional ByVal cLogMessage As String = "")
        Try
            ...
            Dim cFileName As String = HTMain.cLogFile + "_" + cTodaysDate + ".txt"
            Dim cMessage As String = ""

            cMessage = vbCrLf +
                        "-------------------------------------------------------" + vbCrLf +
                        "WinTexTerazi versiyon : " + HTMain.cWinTexTeraziVersion + vbCrLf +
                        "Tarih / Saat : " + Now.ToString + " " + vbCrLf +
                        "Log : " + cLogMessage.Trim + vbCrLf

            If (My.Computer.FileSystem.DirectoryExists(HTMain.cLogDir) = False) Then
                My.Computer.FileSystem.CreateDirectory(HTMain.cLogDir)
            End If
    ...
    Public Sub ErrDisp(Optional ByVal cErrorMessage As String = "", Optional ByVal cFormName As String = "", Optional ByVal cSQL As String = "", Optional ByVal lShowMessage As Boolean = False, Optional oEx As Exception = Nothing)
        Try
            ...
            cMessage = "WinTexTerazi versiyon : " + HTMain.cWinTexTeraziVersion + vbCrLf +
                        "Tarih / Saat : " + Now.ToString + " " + vbCrLf +
            ...
            If (My.Computer.FileSystem.DirectoryExists(HTMain.cErrorDir) = False) Then
                My.Computer.FileSystem.CreateDirectory(HTMain.cErrorDir)
            End If

            File.AppendAllText(HTMain.cErrorFile + "_" + cTodaysDate + ".txt",
                                   vbCrLf +
                                   "-------------------------------------------------------" + vbCrLf +
                                   cMessage + vbCrLf)
