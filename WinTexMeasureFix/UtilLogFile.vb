...
Module UtilLogFile
    ...
    Public Sub CreateLog(Optional ByVal cLogFileName As String = "WinTexMFLog", Optional ByVal cLogMessage As String = "")
        Try
            Dim cTodaysDate As String = String.Format("{0:dd_MM_yyyy}", DateTime.Now)
            Dim cFileName As String = "C:\wintex\WinTexMFLogs\" + cLogFileName + "_" + cTodaysDate + ".txt"
            Dim cMessage As String = ""

            cMessage = vbCrLf +
                        "-------------------------------------------------------" + vbCrLf +
                        "WinTexMNG versiyon : " + HTMain.cWinTexMeasureFixVersion + vbCrLf +
    ...
    Public Sub ErrDisp(Optional ByVal cErrorMessage As String = "", Optional ByVal cFormName As String = "", Optional ByVal cSQL As String = "", Optional ByVal lShowMessage As Boolean = False, Optional oEx As Exception = Nothing)
        Try
            ...
            cMessage = "WinTexMeasureFix versiyon : " + HTMain.cWinTexMeasureFixVersion + vbCrLf +
                        "Tarih / Saat : " + Now.ToString + " " + vbCrLf +
            ...
            If (My.Computer.FileSystem.DirectoryExists("C:\wintex\WinTexMFErrors") = False) Then
                My.Computer.FileSystem.CreateDirectory("C:\wintex\WinTexMFErrors")
            End If

            File.AppendAllText("C:\wintex\WinTexMFErrors\WinTexMFError" + "_" + cTodaysDate + ".txt",
                                   vbCrLf +
                                   "-------------------------------------------------------" + vbCrLf +
                                   cMessage + vbCrLf)
