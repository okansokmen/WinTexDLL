...
Module UtilSQL
    ...
    Public Function OpenConn(Optional nTimeOut As Double = 0) As SqlConnection
        ...
        Try
            If nTimeOut = 0 Then
                cConnStr = oConnection.cConnStr
            Else
                cConnStr = oConnection.cConnStr + ";" + "Connection Timeout = " + nTimeOut.ToString
            End If
            OpenConn = New SqlConnection(cConnStr)
            OpenConn.Open()
    ...
    Public Function SQLWriteDate(ByVal dValue As Date) As String
        ...
        Try
            If Not IsDate(dValue) Then Exit Function
            If CDate(dValue) < #1/1/1950# Then Exit Function
    ...
    Public Function SQLWriteString(ByVal cValue As String, Optional ByVal nLength As Integer = 0) As String
        SQLWriteString = ""
        Try
            If cValue Is Nothing Then Exit Function
    ...
    Public Function SQLReadDouble(ByVal oReader As SqlDataReader, Optional ByVal cFieldName As String = "") As Double
        ...
        Catch ex As Exception
            ErrDisp("SQLReadDouble : " + cFieldName,,,, ex)
        End Try
    End Function
    ...
    Public Function AbitReadString(oValue As Object, Optional ByVal nWidth As Integer = 0) As String
        ...
        Try
            If IsNothing(oValue) Then
                AbitReadString = ""
            Else
                AbitReadString = oValue.ToString.Trim
            End If

            If nWidth > 0 Then
                AbitReadString = Mid(AbitReadString, 1, nWidth).Trim
            End If

        Catch ex As Exception
            ErrDisp("AbitReadString", "utilSQL",,, ex)
        End Try
    End Function
End Module
